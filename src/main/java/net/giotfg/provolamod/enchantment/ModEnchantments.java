...
public class ModEnchantments {
    public static final RegistryKey<Enchantment> LIGHTNING_STRIKER =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(ProvolaMod.MOD_ID, "lightning_striker"));
    ...
    public static void bootstrap(Registerable<Enchantment> registerable) {
        ...
        register(
                registerable, LIGHTNING_STRIKER, Enchantment.builder(Enchantment.definition(
